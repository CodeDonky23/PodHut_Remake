  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(24, 95%, 53%, 0.4)" },
        ...
        "glow-pulse": {
          "0%, 100%": { 
            boxShadow: "0 0 20px -5px hsl(24, 95%, 53%, 0.4), 0 0 40px -10px hsl(38, 92%, 50%, 0.3)"
          },
          "50%": { 
            boxShadow: "0 0 40px -5px hsl(24, 95%, 53%, 0.6), 0 0 60px -10px hsl(38, 92%, 50%, 0.5)"
          },
        },
      },
      animation: {
